...
export default function Home() {
			...
			try {
				...
				setSnippets(( prevSnippets ) => {
					...
					if (existingSnippet) {
						...
						return prevSnippets.map(( snippet ) => snippet.title === title ? {
							...snippet,
							code: textContent
						} : snippet);
					} else {
	...
	const descGithubLinkUsingJS = 'const githubLink = "https://github.com/DenZaiyy/portfolio-ide"';
	...
	return (<div className="home">
		...
		<div className="snippets">
			{snippets.map(( snippet, index ) => (<Snippet key={index} snippet={snippet}/>))}
		</div>
	</div>);
}
