...
const externalLinksList: ExternalLinks[] = [{
	link: "https://www.twitch.tv/denzdev", name: "Twitch channel"
}, {
	link: "https://www.linkedin.com/in/kevin-grischko/", name: "LinkedIn"
}, {
	link: "https://github.com/DenZaiyy", name: "Github"
}];
	...
	return (<div className="contact-me">
		<section className="sub-menu">
			<ul className="tabs text-white">
				<li className="item">
					<input type="checkbox" id="faq1" className="peer appearance-none" defaultChecked={true}/>
				...
				<li className="item">
					<input type="checkbox" id="faq2" className="peer appearance-none" defaultChecked={true}/>
					<RiArrowRightSFill className="peer-checked:hidden inline"/>
					<RiArrowDownSFill className="peer-checked:inline hidden"/>
			...
			<div className="snippets">
				...
				<div className="tab-content">
					<SyntaxHighlighter
						...
						wrapLines={true}
						wrapLongLines={true}
						lineNumberContainerStyle={{width: "1rem", paddingRight: "4rem"}}
						style={atomOneDark}
						lineProps={{
							style: {display: "block", wordBreak: "break-all"}, className: "code-line"
						}}
