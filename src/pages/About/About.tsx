						...
						<div className="peer-checked:max-h-max peer-checked:border-t-[1px] peer-checked:p-3 basis-full border-[var(--lines)] max-h-0 overflow-hidden transition-all duration-100 select-text">
							<ul>
								<li>
									...
									<NavLink to="/about/perso/bio" className="flex flex-row items-center gap-2">
								...
								<li>
									...
									<NavLink to="/about/perso/interests" className="flex flex-row items-center gap-2">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
								...
								<li>
									...
									<NavLink to="/about/perso/education" className="flex flex-row items-center gap-2">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="14" viewBox="0 0 16 14" fill="none">
